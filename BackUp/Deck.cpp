...
void Deck::playerAttack(){
	vector<Card> *itr=&playerHand;
	int userinput=69;
	cout << "It is your turn to attack, choose a card to play\n";
	cin >> userinput;
	userTable.push_back(playerHand[userinput]);
	playerHand.erase(playerHand.begin()+userinput-1);
	prtTable();
}
